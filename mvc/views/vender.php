...
<table class="table bg-light">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      	<a href="<?php echo BASE_URL;?>vender/ven/<?php echo $item['id'];?>" class="btn btn-danger">VENDER</a></td>
    </tr> 
	<?php } ?>
...
<div class="row">
  <div class="col-6">
    <h5 class="modal-title mb-3" id="exampleModalLabel">Vender Produtos</h5>
